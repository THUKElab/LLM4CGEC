...
from transformers import BartForConditionalGeneration, BertTokenizer, T5Tokenizer, T5ForConditionalGeneration, MT5Tokenizer, MT5ForConditionalGeneration
...
def predict():
    ...
    #with open(args.output_path, 'w') as outf:
    #    for i, out in enumerate(outs):
    #        outf.write(out['src'][0]+ " " + out['preds'][0] + "\n")
