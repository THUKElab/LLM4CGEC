...
# Step 2. Training
SEED=2024
PRETRAIN_MODEL=../../../T5-baseline/mengzi-T5-mt/
MODEL_DIR=./exps/hsk-smal-T5-fewshot-nogold-target-hsk-small-2-type
TASK_NAME=gec
CUDA_DEVICE=1
...
#Step 3. Inference
MODEL_PATH=./exps/hsk-smal-T5-fewshot-nogold-target-hsk-small-2-type/gec/run_$SEED
RESULT_DIR=$MODEL_PATH/results
mkdir -p $RESULT_DIR
INPUT_FILE=./nlpcc_nogold_qwen_turbo_gold_fin_input.txt # 输入文件（无需分字）
OUTPUT_FILE=$RESULT_DIR"/hsk-smal-nlpcc-T5-fewshot-nogold-target-hsk-small-2-type.output" # 输出文件
